...
def parse_args(args):
    ...
    parser.add_argument(
        "--clip-alignment-contrastive-loss-weight",
        type=float,
        default=0.9,
        help="Weight assigned to CLIP loss in Alignment."
    )
    parser.add_argument(
        "--alignment-loss-weight",
        type=float,
        default=0.1,
        help="Weight assigned to Differential Kernel loss during the Alignment."
    )
    parser.add_argument(
        "--alignment-reference-path",
        type=float,
        default=None,
        help="Path to NPZ file containing features of reference model to align with."
    )
    parser.add_argument(
        "--remote-sync",
        type=str,
