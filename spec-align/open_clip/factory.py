...
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, AlignmentClipLoss
...
def create_loss(args):
    return AlignmentClipLoss(
        clip_loss_weight=args.alignment_loss_weight,
        custom_loss_weight=args.clip_alignment_contrastive_loss_weight,  # Add custom loss weight parameter
        local_loss=args.local_loss,
        gather_with_grad=args.gather_with_grad,
        ref_features=None, # TODO: np.load(args.alignment_reference_path)['dino_features'],
        cache_labels=True,
        rank=args.rank,
